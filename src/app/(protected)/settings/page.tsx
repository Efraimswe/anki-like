...
const settingsLinks = [
  { href: '/settings/profile', label: 'Profile', description: 'Update your display name and account details', Icon: UserRound },
  { href: '/settings/sessions', label: 'Sessions', description: 'Review active devices and revoke access', Icon: ShieldCheck },
];
